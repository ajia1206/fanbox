...
window.FANBOX_DICT = {
  ...
  'Agent 任务总览 / 待接手队列': 'Agent task overview / handoff queue',
  ...
  // ---------- 变更收件箱 / 会话回放 ----------
  'Agent 任务总览': 'Agent task overview',
  '从内嵌终端和本会话变更实时汇总': "Live summary from embedded terminals and this session's changes",
  '打开终端后会自动汇总 agent 状态': 'Open a terminal and agent state will appear automatically',
  '桌面版内嵌终端可显示 agent 状态': 'The desktop embedded terminal can show agent state',
  '变更': 'Changes',
  '录像': 'Recordings',
  '待接手': 'Handoff',
  '运行中': 'Running',
  '最近收工': 'Recently done',
  '最近产物': 'Recent outputs',
  '没有等待你确认的 agent。': 'No agent is waiting for your confirmation.',
  '当前没有运行中的 agent。': 'No agent is currently running.',
  '还没有本次会话的收工记录。': 'No completion records in this session yet.',
  '还没有捕捉到 agent 写入的文件。': 'No agent-written files captured yet.',
  '先用顶栏“终端”启动 Claude 或 Codex；任务、确认点和改过的文件会排到这里。': 'Start Claude or Codex from the top-bar Terminal; tasks, confirmation points, and changed files will queue here.',
  '当前是浏览器版；桌面 App 里的内嵌终端会把 agent 状态排到这里。': 'This is the browser version; the desktop app embedded terminal will queue agent state here.',
  '点一行会直接切到对应终端；输入后会从待接手队列移除。': 'Click a row to jump to that terminal; typing removes it from the handoff queue.',
  '已退出': 'Exited',
  '已收工': 'Done',
  '停在确认界面': 'Stopped at a confirmation prompt',
  '终端有输出，正在推进': 'Terminal output is active',
  '进程已退出': 'Process exited',
  '暂无摘要': 'No summary yet',
  '未知目录': 'Unknown folder',
